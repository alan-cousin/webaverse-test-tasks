...
(async () => {
    ...
    {
        const targetPage = page;
        await targetPage.setViewport({"width":1920,"height":937})
    }
    {
        const targetPage = page;
        const promises = [];
        promises.push(targetPage.waitForNavigation());
        await targetPage.goto("https://webaverse-alan-cousin.netlify.app/");
        await Promise.all(promises);
    }
    {
        const targetPage = page;
        const element = await waitForSelectors([["#maincontent > canvas"]], targetPage, { timeout, visible: true });
    ...
    {
        const targetPage = page;
        await targetPage.keyboard.down("z");
    }
    {
        const targetPage = page;
        await targetPage.keyboard.up("z");
    }
    {
        const targetPage = page;
        await targetPage.keyboard.down(" ");
